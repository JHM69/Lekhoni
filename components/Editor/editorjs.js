...
const Kt = {
  ...
  /**
   * Find messages div by namespace path
   *
   * @param namespace - path to div
   */
...
class Pe extends C {
  /**
   * Return namespace div for tool or block tune
   *
...
class jo extends C {
  ...
  /**
   * Panel with block settings with 2 divs:
   *  - Tool's Settings
